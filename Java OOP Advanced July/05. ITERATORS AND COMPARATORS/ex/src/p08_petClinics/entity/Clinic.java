...
public class Clinic {
    ...
    private static final String INVALID_NAME_EX_MESSAGE = "Invalid clinic name! Need be String containing of " +
            "alphabetical characters with length [1-50]!";
    private static final String INVALID_OPERATION_EX_MESSAGE = "Invalid Operation!";
