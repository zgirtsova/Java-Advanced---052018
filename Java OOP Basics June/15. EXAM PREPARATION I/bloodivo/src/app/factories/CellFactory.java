...
public final class CellFactory {
    ...
    public static Cell createCell(String cellType, String cellId, int health,
                                  int rows, int cols, int addProperty) {
        ...
        switch (cellType){
            ...
            case "Fungi": return new Fungi(cellId, health, rows, cols, addProperty);
            case "Virus": return new Virus(cellId, health, rows, cols, addProperty);
            case "Bacteria": return new Bacteria(cellId, health, rows, cols, addProperty);
            default: return null;
        }
    }
}
